...
typedef struct outline_t
{
  ...
  struct outline_t* (*move_to)(struct outline_t* self, 
			       vector2d_t* to);

  /* creates a line */
  struct outline_t* (*line_to)(struct outline_t* self, 
		  vector2d_t* to);

  /* one control point, one destination */
  struct outline_t* (*conic_to)(struct outline_t* self, 
		   vector2d_t* control, 
		   vector2d_t* to);
  /* two control points, one destination */
  struct outline_t* (*cubic_to)(struct outline_t* self, 
		   vector2d_t* control1, vector2d_t* control2, 
		   vector2d_t* to);
  
  /* scale outline */
  struct outline_t* (*scale)(struct outline_t* self, vector2d_t* scaling_factors);
  /* rotation */
  struct outline_t* (*rotate)(struct outline_t* self, double angle);
  /* translate */
  struct outline_t* (*translate)(struct outline_t* self, vector2d_t* displacement);
