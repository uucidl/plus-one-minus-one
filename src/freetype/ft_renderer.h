 ...
 *
 * You should have received this file ('src/freetype/ft_renderer.h') with a license
...
typedef struct ft_renderer_t
{
    ...
    */
    ...
    void (*draw_string)(struct ft_renderer_t* self,
			image_t* image, string_t* string);

    /* compute the necessary size for displaying this string, and return it inside the image_t* structure */
    void (*compute_string_extent) (struct ft_renderer_t* self, image_t* destination, string_t* string);

    void (*draw_cstring)(struct ft_renderer_t* self,
			 image_t* image, const char* string);

    void (*draw_outline)(struct ft_renderer_t* self,
			 image_t* image,
			 outline_t* outline);
    /*
