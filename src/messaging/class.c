...
static
atom_t class_attach_instance(class_t* self, receiver_t* receiver)
{
    atom_t id = 0;
	...
	TRACE3("added instance '%s' of class '%s'", 
	       atom_get_cstring_value(id), atom_get_cstring_value(self->class));
    }
