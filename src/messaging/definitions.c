 ...
 *
 * You should have received this file ('src/messaging/definitions.c') with a license
...
static
desc_t* definitions_get_desc(definitions_t* self, atom_t a)
{
...
*/
static
void definitions_set_callback(definitions_t* self, 
