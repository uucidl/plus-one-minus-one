 ...
 *
 * You should have received this file ('src/messaging/definitions.h') with a license
...
typedef struct definitions_t
{
    object_t super;
    /*
      a definition is accepted in the form of a bytecode_stream of atoms identifying the types of
      the arguments. (accepted: atom:integer, atom:float, atom:atom)
     */
    void (*set_callback)(struct definitions_t* self, 
