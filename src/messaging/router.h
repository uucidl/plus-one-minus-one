...
typedef struct router_t
{
    ...
    void (*set_child)(struct router_t* self, 
		      atom_t name, receiver_t* children);


    void (*receive_backup)(receiver_t* self, 
...
static inline
router_t* wildcard_router_instantiate_toplevel (router_t* x) {
    if (x) {
...
/* accessors */
static inline 
receiver_t* router_get_receiver(router_t* r) __attribute__((unused));

static inline
receiver_t* router_get_receiver(router_t* r)
{
  return &r->super;
}
