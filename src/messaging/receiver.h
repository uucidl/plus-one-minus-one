 ...
 *
 * You should have received this file ('src/messaging/receiver.h') with a license
...
typedef struct receiver_t
{
    ...
    /* add and sets the definition for this atom, and create
       message fifo queue */
    void (*set_definition)(struct receiver_t* self, 
			   atom_t a, bytecode_stream_t* args, recp_f f);

    /* evaluate one message */
    void (*eval)(struct receiver_t* self, 
		 bytecode_stream_t* message, 
		 context_t* context);

    /* evaluate all messages received for the given selector in the given context */
    void (*eval_pending)(struct receiver_t* self, 
			 atom_t selector, 
			 context_t* context);
    ...
    message_node_t* (*peek_pending)(struct receiver_t* self,
				    atom_t selector,
				    context_t* context);
    ...
    */
    void (*receive)(struct receiver_t* self, 
