 ...
 *
 * Last edited: Thu Mar 25 03:44:47 1999 by piumarta (Ian Piumarta) on felina
 */
...
#define _s1(I)                                                                 \
    (_s1P(I) ? ((unsigned)(I)&0x000000ff)                                      \
             : ASMFAIL("8-bit signed immediate required"))
#define _s2(I)                                                                 \
    (_s2P(I) ? ((unsigned)(I)&0x0000ffff)                                      \
             : ASMFAIL("16-bit signed immediate required"))
...
#define _d1(I)                                                                 \
    (_s1P(I) ? ((unsigned)(I)&0x000000ff)                                      \
             : ASMFAIL("8-bit displacement out of range"))

/*** ASSEMBLER ***/

#define _UC(X) ((unsigned char)(X))
#define _PUC(X) ((unsigned char *)(X))
#define _US(X) ((unsigned short)(X))
#define _PUS(X) ((unsigned short *)(X))
#define _UL(X) ((unsigned long)(X))
#define _PUL(X) ((unsigned long *)(X))
    ...
    (((N) == 0)                                                                \
         ...
         : ((N) == 1)                                                          \
               ...
               : ((N) == 2)                                                    \
                     ? (_B(0x89), _B(0xf6))                                    \
                     : ((N) == 3)                                              \
                           ? (_B(0x8d), _B(0x76), _B(0x00))                    \
                           : ((N) == 4)                                        \
                                 ? (_B(0x8d), _B(0x74), _B(0x26), _B(0x00))    \
                                 : ((N) == 5)                                  \
                                       ? (_B(0x90), _B(0x8d), _B(0x74),        \
                                          _B(0x26), _B(0x00))                  \
                                       : ((N) == 6)                            \
                                             ? (_B(0x8d), _B(0xb6), _B(0x00),  \
                                                _B(0x00), _B(0x00), _B(0x00))  \
                                             : ((N) == 7)                      \
                                                   ? (_B(0x8d), _B(0xb4),      \
                                                      _B(0x26), _B(0x00),      \
                                                      _B(0x00), _B(0x00),      \
...
#define _r_0BIS(R, B, I, S)                                                    \
    (_Mrm(_b00, _rN(R), _b100), _SIB(_SCL(S), _r4(I), _r4(B)))
#define _r_1B(R, D, B) (_Mrm(_b01, _rN(R), _r4(B)), _B(D))
#define _r_1BIS(R, D, B, I, S)                                                 \
    (_Mrm(_b01, _rN(R), _b100), _SIB(_SCL(S), _r4(I), _r4(B)), _B(D))
#define _r_4B(R, D, B) (_Mrm(_b10, _rN(R), _r4(B)), _L(D))
#define _r_4BIS(R, D, B, I, S)                                                 \
    (_Mrm(_b10, _rN(R), _b100), _SIB(_SCL(S), _r4(I), _r4(B)), _L(D))

#define _r_DB(R, D, B)                                                         \
    ((_s0P(D) ? _r_0B(R, B) : (_s1P(D) ? _r_1B(R, D, B) : _r_4B(R, D, B))))
#define _r_DBIS(R, D, B, I, S)                                                 \
    ((_s0P(D) ? _r_0BIS(R, B, I, S)                                            \
              : (_s1P(D) ? _r_1BIS(R, D, B, I, S) : _r_4BIS(R, D, B, I, S))))

#define _r_X(R, D, B, I, S)                                                    \
    (_r0P(I)                                                                   \
         ? (_r0P(B) ? _r_D(R, D) : (_ESP == (B) ? _r_DBIS(R, D, _ESP, _ESP, 1) \
                                                : _r_DB(R, D, B)))             \
...
#define _O_r_X_B(OP, R, MD, MB, MI, MS, B)                                     \
    (_O(OP), _r_X(R, MD, MB, MI, MS), _B(B))
#define _O_r_X_W(OP, R, MD, MB, MI, MS, W)                                     \
    (_O(OP), _r_X(R, MD, MB, MI, MS), _W(W))
#define _O_r_X_L(OP, R, MD, MB, MI, MS, L)                                     \
    (_O(OP), _r_X(R, MD, MB, MI, MS), _L(L))
#define _OO_r_X_B(OP, R, MD, MB, MI, MS, B)                                    \
    (_OO(OP), _r_X(R, MD, MB, MI, MS), _B(B))
#define _Os_r_X_sW(OP, R, MD, MB, MI, MS, W)                                   \
    (_Os(OP, W), _r_X(R, MD, MB, MI, MS), _sW(W))
#define _Os_r_X_sL(OP, R, MD, MB, MI, MS, L)                                   \
...
#define _wO_r_X_B(OP, R, MD, MB, MI, MS, B)                                    \
    (_d16(), _O_r_X_B(OP, R, MD, MB, MI, MS, B))
#define _wOO_r_X_B(OP, R, MD, MB, MI, MS, B)                                   \
    (_d16(), _OO_r_X_B(OP, R, MD, MB, MI, MS, B))
#define _wO_r_X_W(OP, R, MD, MB, MI, MS, W)                                    \
    (_d16(), _O_r_X_W(OP, R, MD, MB, MI, MS, W))
#define _wOs_r_X_sW(OP, R, MD, MB, MI, MS, W)                                  \
...
#define ADCBim(IM, MD, MB, MI, MS)                                             \
    _O_r_X_B(0x80, _b010, MD, MB, MI, MS, _s1(IM))
...
#define ADCWim(IM, MD, MB, MI, MS)                                             \
    _wOs_r_X_sW(0x81, _b010, MD, MB, MI, MS, _s2(IM))
...
#define ADDBim(IM, MD, MB, MI, MS)                                             \
    _O_r_X_B(0x80, _b000, MD, MB, MI, MS, _s1(IM))
...
#define ADDWim(IM, MD, MB, MI, MS)                                             \
    _wOs_r_X_sW(0x81, _b000, MD, MB, MI, MS, _s2(IM))
...
#define ANDBim(IM, MD, MB, MI, MS)                                             \
    _O_r_X_B(0x80, _b100, MD, MB, MI, MS, _s1(IM))
...
#define ANDWim(IM, MD, MB, MI, MS)                                             \
    _wOs_r_X_sW(0x81, _b100, MD, MB, MI, MS, _s2(IM))
...
#define BTWim(IM, MD, MB, MI, MS)                                              \
    _wOO_r_X_B(0x0fba, _b100, MD, MB, MI, MS, _u1(IM))
...
#define BTLim(IM, MD, MB, MI, MS)                                              \
    _OO_r_X_B(0x0fba, _b100, MD, MB, MI, MS, _u1(IM))
...
#define BTCWim(IM, MD, MB, MI, MS)                                             \
    _wOO_r_X_B(0x0fba, _b111, MD, MB, MI, MS, _u1(IM))
...
#define BTCLim(IM, MD, MB, MI, MS)                                             \
    _OO_r_X_B(0x0fba, _b111, MD, MB, MI, MS, _u1(IM))
...
#define BTRWim(IM, MD, MB, MI, MS)                                             \
    _wOO_r_X_B(0x0fba, _b110, MD, MB, MI, MS, _u1(IM))
...
#define BTRLim(IM, MD, MB, MI, MS)                                             \
    _OO_r_X_B(0x0fba, _b110, MD, MB, MI, MS, _u1(IM))
...
#define BTSWim(IM, MD, MB, MI, MS)                                             \
    _wOO_r_X_B(0x0fba, _b101, MD, MB, MI, MS, _u1(IM))
...
#define BTSLim(IM, MD, MB, MI, MS)                                             \
    _OO_r_X_B(0x0fba, _b101, MD, MB, MI, MS, _u1(IM))
#define BTSLrr(RS, RD) _OO_Mrm(0x0fab, _b11, _r4(RS), _r4(RD))
#define BTSLrm(RS, MD, MB, MI, MS) _OO_r_X(0x0fab, _r4(RS), MD, MB, MI, MS)

#define CALLm(MD, MB, MI, MS)                                                  \
    ((_r0P(MB) && _r0P(MI)) ? _O_D4(0xe8, (int)(MD))                           \
...
#define CMPBim(IM, MD, MB, MI, MS)                                             \
    _O_r_X_B(0x80, _b111, MD, MB, MI, MS, _s1(IM))
...
#define CMPWim(IM, MD, MB, MI, MS)                                             \
    _wOs_r_X_sW(0x81, _b111, MD, MB, MI, MS, _s2(IM))
...
#define DIVBmr(MD, MB, MI, MS, RD)                                             \
    (_rAL(RD) + _O_r_X(0xf6, _b110, MD, MB, MI, MS))

#define DIVWrr(RS, RD) (_rAX(RD) + _wO_Mrm(0xf7, _b11, _b110, _r2(RS)))
#define DIVWmr(MD, MB, MI, MS, RD)                                             \
    (_rAX(RD) + _wO_r_X(0xf7, _b110, MD, MB, MI, MS))

#define DIVLrr(RS, RD) (_rEAX(RD) + _O_Mrm(0xf7, _b11, _b110, _r4(RS)))
#define DIVLmr(MD, MB, MI, MS, RD)                                             \
    (_rEAX(RD) + _O_r_X(0xf7, _b110, MD, MB, MI, MS))

#define ENTERii(W, B) _O_W_B(0xc8, _s2(W), _s1(B))
#define HLT() _O(0xf4)

#define IDIVBrr(RS, RD) (_rAL(RD) + _O_Mrm(0xf6, _b11, _b111, _r1(RS)))
#define IDIVBmr(MD, MB, MI, MS, RD)                                            \
    (_rAL(RD) + _O_r_X(0xf6, _b111, MD, MB, MI, MS))

#define IDIVWrr(RS, RD) (_rAX(RD) + _wO_Mrm(0xf7, _b11, _b111, _r2(RS)))
#define IDIVWmr(MD, MB, MI, MS, RD)                                            \
    (_rAX(RD) + _wO_r_X(0xf7, _b111, MD, MB, MI, MS))

#define IDIVLrr(RS, RD) (_rEAX(RD) + _O_Mrm(0xf7, _b11, _b111, _r4(RS)))
#define IDIVLmr(MD, MB, MI, MS, RD)                                            \
    (_rEAX(RD) + _O_r_X(0xf7, _b111, MD, MB, MI, MS))
...
#define IMULWimr(IM, MD, MB, MI, MS, RD)                                       \
    _wOs_r_X_sW(0x69, _r2(RD), MD, MB, MI, MS, IM)
...
#define JCCSim(CC, D, B, I, S)                                                 \
    ((_r0P(B) && _r0P(I)) ? _O_D1(0x70 | (CC), (int)(D))                       \
...
#define JCCim(CC, D, B, I, S)                                                  \
    ((_r0P(B) && _r0P(I)) ? _OO_D4(0x0f80 | (CC), (int)(D))                    \
                          : ASMFAIL("illegal mode in conditional jump"))
...
#define JMPSm(D, B, I, S)                                                      \
    ((_r0P(B) && _r0P(I)) ? _O_D1(0xeb, D)                                     \
                          : ASMFAIL("illegal mode in short jump"))

#define JMPm(D, B, I, S)                                                       \
    ((_r0P(B) && _r0P(I)) ? _O_D4(0xe9, D)                                     \
                          : ((_r0P(I)) ? _O_Mrm(0xff, _b11, _b110, _r4(B))     \
                                       : _O_r_X(0xff, _b100, D, B, I, S)))
...
#define LOOPm(MD, MB, MI, MS)                                                  \
    ((_r0P(MB) && _r0P(MI)) ? _O_D1(0xe2, MD) : ASMFAIL("illegal mode in "     \
                                                        "loop"))

#define LOOPEm(MD, MB, MI, MS)                                                 \
    ((_r0P(MB) && _r0P(MI)) ? _O_D1(0xe1, MD)                                  \
...
#define MULBmr(MD, MB, MI, MS, RD)                                             \
    (_rAL(RD) + _O_r_X(0xf6, _b100, MD, MB, MI, MS))

#define MULWrr(RS, RD) (_rAX(RD) + _wO_Mrm(0xf7, _b11, _b100, _r2(RS)))
#define MULWmr(MD, MB, MI, MS, RD)                                             \
    (_rAX(RD) + _wO_r_X(0xf7, _b100, MD, MB, MI, MS))

#define MULLrr(RS, RD) (_rEAX(RD) + _O_Mrm(0xf7, _b11, _b100, _r4(RS)))
#define MULLmr(MD, MB, MI, MS, RD)                                             \
    (_rEAX(RD) + _O_r_X(0xf7, _b100, MD, MB, MI, MS))
...
#define ORWim(IM, MD, MB, MI, MS)                                              \
    _wOs_r_X_sW(0x81, _b001, MD, MB, MI, MS, _s2(IM))
...
#define ROLBir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd0, _b11, _b000, _r1(RD))                          \
                 : _O_Mrm_B(0xc0, _b11, _b000, _r1(RD), u1(IM)))
#define ROLBim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd0, _b000, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc0, _b000, MD, MB, MI, MS, u1(IM)))
#define ROLBrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd2, _b11, _b000, _r1(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define ROLBrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd2, _b000, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))

#define ROLWir(IM, RD)                                                         \
    (((IM) == 1) ? _wO_Mrm(0xd1, _b11, _b000, _r2(RD))                         \
                 : _wO_Mrm_B(0xc1, _b11, _b000, _r2(RD), u1(IM)))
#define ROLWim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _wO_r_X(0xd1, _b000, MD, MB, MI, MS)                        \
                 : _wO_r_X_B(0xc1, _b000, MD, MB, MI, MS, u1(IM)))
#define ROLWrr(RS, RD)                                                         \
    (((RS) == _CL) ? _wO_Mrm(0xd3, _b11, _b000, _r2(RD))                       \
                   : ASMFAIL("source register must be CL"))
#define ROLWrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _wO_r_X(0xd3, _b000, MD, MB, MI, MS)                      \
                   : ASMFAIL("source register must be CL"))

#define ROLLir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd1, _b11, _b000, _r4(RD))                          \
                 : _O_Mrm_B(0xc1, _b11, _b000, _r4(RD), u1(IM)))
#define ROLLim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd1, _b000, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc1, _b000, MD, MB, MI, MS, u1(IM)))
#define ROLLrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd3, _b11, _b000, _r4(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define ROLLrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd3, _b000, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))

#define RORBir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd0, _b11, _b001, _r1(RD))                          \
                 : _O_Mrm_B(0xc0, _b11, _b001, _r1(RD), u1(IM)))
#define RORBim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd0, _b001, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc0, _b001, MD, MB, MI, MS, u1(IM)))
#define RORBrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd2, _b11, _b001, _r1(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define RORBrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd2, _b001, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))

#define RORWir(IM, RD)                                                         \
    (((IM) == 1) ? _wO_Mrm(0xd1, _b11, _b001, _r2(RD))                         \
                 : _wO_Mrm_B(0xc1, _b11, _b001, _r2(RD), u1(IM)))
#define RORWim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _wO_r_X(0xd1, _b001, MD, MB, MI, MS)                        \
                 : _wO_r_X_B(0xc1, _b001, MD, MB, MI, MS, u1(IM)))
#define RORWrr(RS, RD)                                                         \
    (((RS) == _CL) ? _wO_Mrm(0xd3, _b11, _b001, _r2(RD))                       \
                   : ASMFAIL("source register must be CL"))
#define RORWrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _wO_r_X(0xd3, _b001, MD, MB, MI, MS)                      \
                   : ASMFAIL("source register must be CL"))

#define RORLir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd1, _b11, _b001, _r4(RD))                          \
                 : _O_Mrm_B(0xc1, _b11, _b001, _r4(RD), u1(IM)))
#define RORLim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd1, _b001, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc1, _b001, MD, MB, MI, MS, u1(IM)))
#define RORLrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd3, _b11, _b001, _r4(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define RORLrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd3, _b001, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))
...
#define SARBir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd0, _b11, _b111, _r1(RD))                          \
                 : _O_Mrm_B(0xc0, _b11, _b111, _r1(RD), u1(IM)))
#define SARBim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd0, _b111, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc0, _b111, MD, MB, MI, MS, u1(IM)))
#define SARBrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd2, _b11, _b111, _r1(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define SARBrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd2, _b111, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))

#define SARWir(IM, RD)                                                         \
    (((IM) == 1) ? _wO_Mrm(0xd1, _b11, _b111, _r2(RD))                         \
                 : _wO_Mrm_B(0xc1, _b11, _b111, _r2(RD), u1(IM)))
#define SARWim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _wO_r_X(0xd1, _b111, MD, MB, MI, MS)                        \
                 : _wO_r_X_B(0xc1, _b111, MD, MB, MI, MS, u1(IM)))
#define SARWrr(RS, RD)                                                         \
    (((RS) == _CL) ? _wO_Mrm(0xd3, _b11, _b111, _r2(RD))                       \
                   : ASMFAIL("source register must be CL"))
#define SARWrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _wO_r_X(0xd3, _b111, MD, MB, MI, MS)                      \
                   : ASMFAIL("source register must be CL"))

#define SARLir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd1, _b11, _b111, _r4(RD))                          \
                 : _O_Mrm_B(0xc1, _b11, _b111, _r4(RD), u1(IM)))
#define SARLim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd1, _b111, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc1, _b111, MD, MB, MI, MS, u1(IM)))
#define SARLrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd3, _b11, _b111, _r4(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define SARLrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd3, _b111, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))
...
#define SBBBim(IM, MD, MB, MI, MS)                                             \
    _O_r_X_B(0x80, _b011, MD, MB, MI, MS, _s1(IM))
...
#define SBBWim(IM, MD, MB, MI, MS)                                             \
    _wOs_r_X_sW(0x81, _b011, MD, MB, MI, MS, _s2(IM))
...
#define SHLBir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd0, _b11, _b100, _r1(RD))                          \
                 : _O_Mrm_B(0xc0, _b11, _b100, _r1(RD), _u1(IM)))
#define SHLBim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd0, _b100, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc0, _b100, MD, MB, MI, MS, u1(IM)))
#define SHLBrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd2, _b11, _b100, _r1(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define SHLBrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd2, _b100, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))

#define SHLWir(IM, RD)                                                         \
    (((IM) == 1) ? _wO_Mrm(0xd1, _b11, _b100, _r2(RD))                         \
                 : _wO_Mrm_B(0xc1, _b11, _b100, _r2(RD), u1(IM)))
#define SHLWim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _wO_r_X(0xd1, _b100, MD, MB, MI, MS)                        \
                 : _wO_r_X_B(0xc1, _b100, MD, MB, MI, MS, u1(IM)))
#define SHLWrr(RS, RD)                                                         \
    (((RS) == _CL) ? _wO_Mrm(0xd3, _b11, _b100, _r2(RD))                       \
                   : ASMFAIL("source register must be CL"))
#define SHLWrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _wO_r_X(0xd3, _b100, MD, MB, MI, MS)                      \
                   : ASMFAIL("source register must be CL"))

#define SHLLir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd1, _b11, _b100, _r4(RD))                          \
                 : _O_Mrm_B(0xc1, _b11, _b100, _r4(RD), u1(IM)))
#define SHLLim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd1, _b100, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc1, _b100, MD, MB, MI, MS, u1(IM)))
#define SHLLrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd3, _b11, _b100, _r4(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define SHLLrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd3, _b100, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))

#define SHRBir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd0, _b11, _b101, _r1(RD))                          \
                 : _O_Mrm_B(0xc0, _b11, _b101, _r1(RD), u1(IM)))
#define SHRBim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd0, _b101, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc0, _b101, MD, MB, MI, MS, u1(IM)))
#define SHRBrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd2, _b11, _b101, _r1(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define SHRBrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd2, _b101, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))

#define SHRWir(IM, RD)                                                         \
    (((IM) == 1) ? _wO_Mrm(0xd1, _b11, _b101, _r2(RD))                         \
                 : _wO_Mrm_B(0xc1, _b11, _b101, _r2(RD), u1(IM)))
#define SHRWim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _wO_r_X(0xd1, _b101, MD, MB, MI, MS)                        \
                 : _wO_r_X_B(0xc1, _b101, MD, MB, MI, MS, u1(IM)))
#define SHRWrr(RS, RD)                                                         \
    (((RS) == _CL) ? _wO_Mrm(0xd3, _b11, _b101, _r2(RD))                       \
                   : ASMFAIL("source register must be CL"))
#define SHRWrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _wO_r_X(0xd3, _b101, MD, MB, MI, MS)                      \
                   : ASMFAIL("source register must be CL"))

#define SHRLir(IM, RD)                                                         \
    (((IM) == 1) ? _O_Mrm(0xd1, _b11, _b101, _r4(RD))                          \
                 : _O_Mrm_B(0xc1, _b11, _b101, _r4(RD), u1(IM)))
#define SHRLim(IM, MD, MB, MS, MI)                                             \
    (((IM) == 1) ? _O_r_X(0xd1, _b101, MD, MB, MI, MS)                         \
                 : _O_r_X_B(0xc1, _b101, MD, MB, MI, MS, u1(IM)))
#define SHRLrr(RS, RD)                                                         \
    (((RS) == _CL) ? _O_Mrm(0xd3, _b11, _b101, _r4(RD))                        \
                   : ASMFAIL("source register must be CL"))
#define SHRLrm(RS, MD, MB, MS, MI)                                             \
    (((RS) == _CL) ? _O_r_X(0xd3, _b101, MD, MB, MI, MS)                       \
                   : ASMFAIL("source register must be CL"))
...
#define SUBBim(IM, MD, MB, MI, MS)                                             \
    _O_r_X_B(0x80, _b101, MD, MB, MI, MS, _s1(IM))
...
#define SUBWim(IM, MD, MB, MI, MS)                                             \
    _wOs_r_X_sW(0x81, _b101, MD, MB, MI, MS, _s2(IM))
...
#define TESTBim(IM, MD, MB, MI, MS)                                            \
    _O_r_X_B(0xf6, _b000, MD, MB, MI, MS, _u1(IM))
...
#define TESTWim(IM, MD, MB, MI, MS)                                            \
    _wO_r_X_W(0xf7, _b000, MD, MB, MI, MS, _u2(IM))
...
#define XORBim(IM, MD, MB, MI, MS)                                             \
    _O_r_X_B(0x80, _b110, MD, MB, MI, MS, _s1(IM))
...
#define XORWim(IM, MD, MB, MI, MS)                                             \
    _wOs_r_X_sW(0x81, _b110, MD, MB, MI, MS, _s2(IM))
...
#define PUSHr(R)                                                               \
    ((_r4P(R) ? PUSHLr(R) : _r2P(R) ? PUSHWr(R)                                \
                                    : ASMFAIL("illegal register size")))
#define POPr(R)                                                                \
    ((_r4P(R) ? POPLr(R) : _r2P(R) ? POPWr(R)                                  \
                                   : ASMFAIL("illegal register size")))
...
#define _ALIGNo(D) __ALIGN(_UL(asm_pc) % (D))
 ...
 */
/*												*/
/* [2] "Intel Architecture Software Developer's Manual Volume 2: Instruction Set
 * Reference",	*/
/*     Intel Corporation 1997.
 */
