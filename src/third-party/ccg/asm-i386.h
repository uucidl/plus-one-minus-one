...
#define _s1(I)		(_s1P(I) ? ((unsigned)(I) & 0x000000ff) : ASMFAIL( "8-bit signed immediate required"))
#define _s2(I)		(_s2P(I) ? ((unsigned)(I) & 0x0000ffff) : ASMFAIL("16-bit signed immediate required"))
...
#define _d1(I)		(_s1P(I) ? ((unsigned)(I) & 0x000000ff) : ASMFAIL( "8-bit displacement out of range"))
...
#define JMPSm(D,B,I,S)			((_r0P(B) && _r0P(I)) ? _O_D1	(0xeb			,D			) : \
							        ASMFAIL("illegal mode in short jump"))

#define JMPm(D,B,I,S)			((_r0P(B) && _r0P(I)) ? _O_D4	(0xe9			,D			) : \
