/* Dynamic assembler for Sparc
 *
 * Copyright (C) 1999 Ian Piumarta <ian.piumarta@inria.fr>
 * See the file COPYRIGHT for details.
 *
 * Last edited: Thu Mar 25 14:38:32 1999 by piumarta (Ian Piumarta) on fricotin
 */
...
#define _ck_s(W, I)                                                            \
    (_siP(W, I)                                                                \
         ? (_UL(I) & _MASK(W))                                                 \
         : ASMFAIL("signed integer " #I " too large for " #W "-bit field"))
#define _ck_u(W, I)                                                            \
    (_uiP(W, I)                                                                \
         ? (_UL(I) & _MASK(W))                                                 \
         : ASMFAIL("unsigned integer " #I " too large for " #W "-bit field"))
#define _ck_d(W, I)                                                            \
    (_siP(W, I)                                                                \
         ? (_UL(I) & _MASK(W))                                                 \
         : ASMFAIL("displacement " #I " too large for " #W "-bit field"))
...
#define _d22(BD)                                                               \
    ((asm_pass == 2) ? _ck_d(22, _d30(BD)) : (_d30(BD) & _MASK(22)))
...
#define _2i(OP, RD, OP2, IMM)                                                  \
    _GEN((_u2(OP) << 30) | (_u5(RD) << 25) | (_u3(OP2) << 22) | _u22(IMM))
#define _2(OP, A, CC, OP2, DSP)                                                \
    _GEN((_u2(OP) << 30) | (_u1(A) << 29) | (_u4(CC) << 25) |                  \
         (_u3(OP2) << 22) | _d22(DSP))

#define _3(OP, RD, OP3, RS1, I, ASI, RS2)                                      \
    _GEN((_u2(OP) << 30) | (_u5(RD) << 25) | (_u6(OP3) << 19) |                \
         (_u5(RS1) << 14) | (_u1(I) << 13) | (_u8(ASI) << 5) | _u5(RS2))
#define _3i(OP, RD, OP3, RS1, I, IMM)                                          \
    _GEN((_u2(OP) << 30) | (_u5(RD) << 25) | (_u6(OP3) << 19) |                \
         (_u5(RS1) << 14) | (_u1(I) << 13) | _s13(IMM))
#define _3f(OP, RD, OP3, RS1, OPF, RS2)                                        \
    _GEN((_u2(OP) << 30) | (_u5(RD) << 25) | (_u6(OP3) << 19) |                \
         (_u5(RS1) << 14) | (_u9(OPF) << 5) | _u5(RS2))
...
#define SETir(I, R)                                                            \
    (_siP(13, I) ? MOVir(I, R) : (SETHIir(_HI(I), R), ORrir(R, _LO(I), R)))
...
/*** References: */
/*                                                                                            */
/* [1] SPARC International, "The SPARC Architecture Manual, Version 8",
 * Prentice-Hall, 1992.  */
