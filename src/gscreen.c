...
static
float gauss_gen(unsigned int d2, unsigned int of)
{
...
static
void set_frame_size(video_effect_t* v, int width, int height, int pitch)
{
...
static
int gscreen_destroy(effect_t* self)
{
...
static
void gscreen_computes(effect_t* self, void* content, double ms)
{
    gscreen_t* scr = (gscreen_t*) self;
    ...
    scr->ps->render(scr->ps, pixels, scr->super.width, scr->super.height, scr->super.pitch);
}
