 ...
 *
 * You should have received this file ('src/library/stack_impl.h') with a license
...
static inline
void stack_push(kn_stack_t* self, void* obj)
{
    if(self->end == NULL) {
...
static inline
void* stack_pop(kn_stack_t* self)
{
    stack_rope_t* r = self->end;
    void* obj = NULL;
...
static inline
void* stack_top(kn_stack_t* self)
{
    return self->end ? stack_rope_top(self->end) : NULL;
}

static inline
unsigned long stack_count(kn_stack_t* self)
{
