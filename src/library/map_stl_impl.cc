 ...
 *
 * You should have received this file ('src/library/map_stl_impl.cc') with a license
...
static 
map_iterator_t* __map_get_iterator (map_t* self, map_iterator_t* iterator)
{
...
map_iterator_t* map_get_iterator(map_t* self, map_iterator_t* iterator)
{
    ...
    iterator_state_t* state = (iterator_state_t*) calloc (sizeof (iterator_state_t), 1);
