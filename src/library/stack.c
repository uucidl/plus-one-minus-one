...
static
int stack_destroy(kn_stack_t* self)
{
  stack_rope_t *r, *old;
  r = self->end;
...
static 
void stack_ppush(kn_stack_t* self, void* obj)
{
  stack_push(self, obj);
}

static
void* stack_ppop(kn_stack_t* self)
{
  return stack_pop(self);
}

static
void* stack_ttop(kn_stack_t* self)
{
  return stack_top(self);
}

static
void stack_dup(kn_stack_t* self)
{
  stack_push(self, stack_top(self));
}

static
void stack_xchg(kn_stack_t* self)
{
...
static
unsigned long stack_ccount(kn_stack_t* self)
{
