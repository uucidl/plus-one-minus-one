...
static
int string_new(string_t* self, const char* src)
{
...
static
int string_destroy(string_t* self)
{
    if(self->end_node) {
...
static
int string_release(object_t* zelf)
{
...
static
char* string_new_c_str(string_t* self)
{
    char* ret = NULL;
...
static
unsigned int string_get_length(string_t* self)
{
    string_node_t* first;
    string_node_t* node;
    unsigned int n = 0;
...
static
void string_node_prepend(string_t* self, string_node_t* node)
{
    string_node_t* first;
...
static 
void string_node_append(string_t* self, string_node_t* node)
{
    string_node_t* first;
    if(self->end_node == NULL) {
	first = node;
...
static
void string_prepend(string_t* self, const char* str)
{
...
static
const char* iterator_next_character(string_iterator_t* self)
{
    const char* c;
...
static
const char* iterator_previous_character(string_iterator_t* self)
{
    const char* c;
...
*/
static
void iterator_delete(string_iterator_t* self, unsigned int n)
{
	...
	if(n < remaining) {
		...
		*self->node = temp;
		self->index = 0; /* useless but more clear (moved to new first position) */
	    } else {
...
static
string_t* iterator_split(string_iterator_t* self, string_t* x)
{
...
/* truncate at point */
static
void iterator_truncate(string_iterator_t* self)
{
...
static
void iterator_insert(string_iterator_t* self, const char* str)
{
    unsigned int len = 0;
...
static
string_iterator_t* string_get_iterator(string_t* self, string_iterator_t* x)
{
...
static
string_t* partition_next(substring_generator_t* self)
{
    ...
    if(self->node && self->parent->get_iterator ((string_t*) self->parent, &it)) {
...
static
substring_generator_t* string_get_substring_generator(const string_t* self, char d, 
