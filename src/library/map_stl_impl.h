 ...
 *
 * You should have received this file ('src/library/map_stl_impl.h') with a
 *license
...
static inline void *inline_map_value_obtain(map_value_t value)
{
    return value.value;
}

static inline int inline_map_value_is_there(map_value_t value)
{
