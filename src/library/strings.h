...
typedef struct string_iterator_t
{
    ...
    /* modifications */
    /* delete current n chars. state of iterator undefined after delete operation */
    ...
    struct string_t* (*split)(struct string_iterator_t* self, struct string_t* x);
    ...
    struct string_t* (*clone_to)(struct string_iterator_t* self, struct string_t* to);
...
typedef struct string_t
{
    ...
    struct string_t* (*clone_to)(const struct string_t* self, struct string_t* to);
    string_iterator_t* (*get_iterator)(struct string_t* self, string_iterator_t* x);
    ...
    substring_generator_t* (*get_substring_generator)(const struct string_t* self, char d, 
