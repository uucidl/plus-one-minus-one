 ...
 *
 * You should have received this file ('src/library/memory_impl.h') with a license
...
*/
static inline
allocator_t* memory_allocator()
{
    return get_top_allocator();
}
...
/*
  ...
  It is advised to use "fat pointers" (pointers to object_t) instead of memory_free
