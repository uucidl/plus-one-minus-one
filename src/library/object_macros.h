 ...
 *
 * You should have received this file ('src/library/object_macros.h') with a
 *license
...
#define OBJECT_INSTANTIATE(class, ancestor)                                    \
    (class##_t *)                                                              \
        object_allocate_debug(class##_to_object(ancestor), sizeof(class##_t),  \
...
#define OBJECT_INSTANTIATE(class, ancestor)                                    \
    (class##_t *)                                                              \
        object_allocate(class##_to_object(ancestor), sizeof(class##_t))
...
#define DEFINE_OBJECT_INSTANTIATE2(class, visibility)                          \
    ...
    OBJECT_MACROS__VISIBILITY_##visibility class##_t *class##_instantiate(     \
        class##_t *x);                                                         \
...
#define DEFINE_OBJECT_INSTANTIATE(class)                                       \
    DEFINE_OBJECT_INSTANTIATE2(class, public)
