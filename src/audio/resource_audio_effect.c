 ...
 *
 * You should have received this file ('src/audio/resource_audio_effect.c') with a license
...
resource_audio_effect_t* resource_audio_effect_instantiate (resource_audio_effect_t* x)
{
    dictionary_t* d           = dictionary_get_instance();
    resource_audio_effect_t* rae = resource_audio_effect_instantiate_super (x);

    rae->set_end_of_stream_receiver = resource_audio_effect_set_end_of_stream_receiver;
