 ...
 *
 * You should have received this file ('src/network/shared_transport.h') with a license
...
struct shared_transport_t* shared_transport_instantiate(struct shared_transport_t* x);
