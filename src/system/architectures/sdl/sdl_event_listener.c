 ...
 *('src/system/architectures/sdl/sdl_event_listener.c') with a license
...
static key_event_t *
key_event_fromSDL_KeyboardEvent(key_event_t *x, const SDL_KeyboardEvent *sdl_ke)
{
    key_event_t *ke = NULL;
    if (sdl_ke) {
...
mouse_event_fromSDL_MouseButtonEvent(mouse_event_t *x,
...
static mouse_event_t *
mouse_event_fromSDL_MouseMotionEvent(mouse_event_t *x,
...
static void event_listener_accept(sdl_event_listener_t *self,
...
static void
sdl_event_listener_set_mouse_motion_correction(sdl_event_listener_t *self,
...
sdl_event_listener_t *sdl_event_listener_instantiate(sdl_event_listener_t *x)
{
    ...
    el->set_mouse_motion_correction =
        sdl_event_listener_set_mouse_motion_correction;
