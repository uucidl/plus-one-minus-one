 ...
 *
 * You should have received this file ('src/system/architectures/sdl/events.h')
 *with a license
...
typedef struct sdl_event_listener_t {
    ...
    void (*accept)(struct sdl_event_listener_t *self, const SDL_Event *event);

    /*
      homothetic correction to the mouse coordinates reported by the motion
      event.
    */
    void (*set_mouse_motion_correction)(struct sdl_event_listener_t *self,
