 ...
 *
 * You should have received this file ('src/system/event_listener.h') with a license
...
typedef struct filtered_listener_t
{
    ...
    void (*set_signature_from_cstring) (struct filtered_listener_t* self, const char* s);
} filtered_listener_t;
...
typedef struct event_listener_t
{
    ...
    void (*add_child)(struct event_listener_t* self, filtered_listener_t* listener);
    void (*remove_child)(struct event_listener_t* self, filtered_listener_t* listener);
