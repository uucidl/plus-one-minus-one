...
static inline object_t *midi_cc_event_to_object(midi_cc_event_t *x)
{
    return event_to_object(x);
}

static inline object_t *midi_noteon_event_to_object(midi_noteon_event_t *x)
{
    return event_to_object(x);
}

static inline object_t *midi_noteoff_event_to_object(midi_noteoff_event_t *x)
{
    return event_to_object(x);
}
