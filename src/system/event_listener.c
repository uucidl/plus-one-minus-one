 ...
 *
 * You should have received this file ('src/system/event_listener.c') with a license
...
static
void event_listener_accept(event_listener_t* self, const event_t* event)
{
...
static
void filtered_listener_set_signature_from_cstring (filtered_listener_t* self, const char* s) {
...
filtered_listener_t* filtered_listener_instantiate(filtered_listener_t* x)
{
  ...
  fl->set_signature_from_cstring = filtered_listener_set_signature_from_cstring;
