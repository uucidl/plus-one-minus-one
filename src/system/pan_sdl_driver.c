 ...
 *
 * You should have received this file ('src/system/pan_sdl_driver.c') with a license
...
static
int pan_sdl_new(struct pan_driver_t* zelf, const char* device, int sample_rate)
{
...
static
int pan_sdl_destroy(struct pan_driver_t* zelf)
{
        pan_sdl_driver_t* self = (pan_sdl_driver_t*) zelf;
...
static
void pan_sdl_start(pan_driver_t* zelf)
{
        pan_sdl_driver_t* self = (pan_sdl_driver_t*) zelf;
...
static
void pan_sdl_stop(pan_driver_t* zelf)
{
        pan_sdl_driver_t* self = (pan_sdl_driver_t*) zelf;
...
static
int pan_sdl_get_samples_number(pan_driver_t* zelf)
{
        pan_sdl_driver_t* self = (pan_sdl_driver_t*) zelf;
...
static
int pan_sdl_get_sample_rate(pan_driver_t* zelf)
{
        pan_sdl_driver_t* self = (pan_sdl_driver_t*) zelf;
...
static
double pan_sdl_get_time(pan_driver_t* zelf)
{
        pan_sdl_driver_t* self = (pan_sdl_driver_t*) zelf;
        return self->time;
}
...
static
int pan_sdl_configure_demo(pan_driver_t* zelf, demo_t* demo)
{
        pan_sdl_driver_t* self = (pan_sdl_driver_t*) zelf;
...
static
void pan_sdl_driver_initialize() __attribute__((constructor));

static
void pan_sdl_driver_initialize()
{
