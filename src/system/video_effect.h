 ...
 *
 * You should have received this file ('src/system/video_effect.h') with a license
...
typedef struct video_effect_t 
{
    ...
    void (*set_frame_size)(struct video_effect_t* self, int width, int height, int pitch);
