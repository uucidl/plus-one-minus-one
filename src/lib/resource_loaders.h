 ...
 *
 * You should have received this file ('src/lib/resource_loaders.h') with a
 *license
...
typedef struct rloader_t {
    ...
    fopen_function (*get_fopen)(struct rloader_t *self, const char *protocol);
    void (*set_fopen)(struct rloader_t *self, const char *protocol,
