 ...
 *
 * You should have received this file ('src/lib/virtual_loader_boot.c') with a license
...
static void 
initializes_resource_virtual_loader () __attribute__((constructor));

static
void initializes_resource_virtual_loader () {
