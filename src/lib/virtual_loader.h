 ...
 *
 * You should have received this file ('src/lib/virtual_loader.h') with a license
...
typedef struct virtual_loader_t
{
    ...
    void   (*set_local_url)(struct virtual_loader_t* self, 
			    const char* vhost, url_t* url);
    local_path_iterator_t* (*get_local_search_path)(struct virtual_loader_t* self, 
						    const char* vhost);
