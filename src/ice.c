...
static
void ice_create_outline(ice_t* self)
{
...
static
void ice_restore_outline(ice_t* self)
{
...
static
int ice_destroy(ice_t* self)
{
  return 1;
}

static
void ice_create(ice_t* self, double gamma, double end_ms, double h)
{
  double u, v, w, s;
...
static
outline_t* ice_update(ice_t* self, double ms)
{
