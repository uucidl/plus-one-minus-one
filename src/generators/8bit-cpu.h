 ...
 *
 * You should have received this file ('src/generators/8bit-cpu.h') with a
 *license
...
typedef enum { NOP, AND, OR, XOR, NEG, SHIFT, ADD, MUL } opcode_t;
...
static inline void _8pu_init(_8pu_t *cpu, unsigned char accum)
{
    int i;
    for (i = 0; i < 8; i++) {
...
static inline void _8pu_next(_8pu_t *cpu)
{
    int i;
    for (i = 0; i < 8; i++) {
