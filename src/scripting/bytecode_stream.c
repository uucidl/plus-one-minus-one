 ...
 *
 * You should have received this file ('src/scripting/bytecode_stream.c') with a license
...
static
bytecode_t* i_next(bytecode_iterator_t* self)
{
    bytecode_t* b = NULL;
...
static
bytecode_t* i_prev(bytecode_iterator_t* self)
{
    bytecode_t* b = NULL;
...
static
int bytecode_stream_release (object_t* zelf)
{
...
static
int bytecode_stream_destroy (struct bytecode_stream_t* self) {
    ERROR3 ("DEPRECATED, don't call this method anymore. caller is: %x - %x", __builtin_return_address (0), __builtin_return_address (1));
    return bytecode_stream_release (bytecode_stream_to_object (self));
}

static
bytecode_stream_t* bytecode_stream_copy(bytecode_stream_t* self,
...
static
unsigned int bytecode_stream_get_count(bytecode_stream_t* self)
{
...
static
bytecode_stream_t* bytecode_stream_append_node(bytecode_stream_t* self, bytecode_node_t* node)
{
...
static
bytecode_stream_t* bytecode_stream_prepend_node(bytecode_stream_t* self, bytecode_node_t* node)
{
    bytecode_node_t* end = self->end;
...
static
bytecode_iterator_t* bytecode_stream_get_iterator(bytecode_stream_t* self, 
...
static
bytecode_iterator_t* bytecode_stream_get_iterator_end(bytecode_stream_t* self, 
				      bytecode_iterator_t* x)
{
...
static
bytecode_node_t* allocate_atom_node(atom_t a)
{
...
static
bytecode_stream_t* bytecode_stream_append_atom(bytecode_stream_t* self, 
					       atom_t a)
{
...
static
bytecode_stream_t* bytecode_stream_prepend_atom(bytecode_stream_t* self, 
					       atom_t a)
{
...
static
bytecode_node_t* allocate_integer_node(int i)
{
    bytecode_node_t* node = bytecode_node_instantiate_toplevel (NULL);
    dictionary_t* dict = dictionary_get_instance();
...
static
bytecode_stream_t* bytecode_stream_append_integer(bytecode_stream_t* self, 
						  int i)
{
...
static
bytecode_stream_t* bytecode_stream_prepend_integer(bytecode_stream_t* self, 
						  int i)
{
...
static
bytecode_node_t* allocate_float_node(float f)
{
    bytecode_node_t* node = bytecode_node_instantiate_toplevel (NULL);
    dictionary_t* dict = dictionary_get_instance();
...
static
bytecode_t* bytecode_stream_pop(bytecode_stream_t* self)
{
...
static
void bytecode_stream_push(bytecode_stream_t* self, bytecode_t* code)
{
    bytecode_node_t* node = bytecode_node_instantiate_toplevel (NULL);
...
bytecode_stream_t* bytecode_stream_instantiate(bytecode_stream_t* x)
{
    ...
    object_set_release_callback (bytecode_stream_to_object (s), bytecode_stream_release);
